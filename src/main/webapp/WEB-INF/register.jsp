    ...
    <body>
        ...
        <div id="bodyPart">
            ...
            <div id="register">
                ...
                <div class="register_content">
                    <div class="clear"></div>
                    <form action="/register.do" method="post" onsubmit="return validateInput()">
                        <div class="user_form">
                            <div class="uInfo">

                                <span class="label">用户名：</span>
                                <input type="text" class="text" name="login_name" id="login_name"/>
                                <span style="color: red">*</span>
                            </div>
                            <div class="uInfo">
                                <span class="label">设置密码：</span>
                                <input type="password" class="text" name="password" id="password1"/>
                                <span style="color: red">*</span>
                            </div>
                            <div class="uInfo">
                                <span class="label">确认密码：</span>
                                <input type="password" class="text" id="password2"/>
                                <span style="color: red">*</span>
                            </div>
                            <div class="uInfo">
                            ...
                            <div class="uInfo">
                                ...
                                <input name="checkcode" type="text" id="code"/>
                                <img id="codeImg" src="/checkcode.do"/>
                                <font>看不清？</font>
                                <a onclick="refreshCode()" style="cursor: pointer">换一张</a>
                            </div>
                            <div class="uInfo">
                    ...
                    <div id="protocol_con">
                        ...
                        <p>
                            本站的各项电子服务的所有权和运作权归本站。本站提供的服务将完全按照其发布的服务条款和操作规则严格执行。用户同意所有服务条款并完成注册程序，才能成为本站的正式用户。用户确认：本协议条款是处理双方权利义务的约定，除非违反国家强制性法律，否则始终有效。在下订单的同时，您也同时承认了您拥有购买这些产品的权利能力和行为能力，并且将您对您在订单中提供的所有信息的真实性负责。</p>
                        <h5>二、服务简介</h5>
        ...
        <script>
            function validateInput() {
                if(!$("#login_name").val() || !$("#password1").val() || !$("#password2").val()){
                    alert("必填项目不能为空!");
                    return false;
            ...
            function refreshCode() {
                $("#codeImg").remove();
                $.ajax({url:'/checkcode.do'});
                let imgEle = document.createElement("img");
                imgEle.id="codeImg";
                imgEle.src='/checkcode.do';
                $("#code").after(imgEle);
            }
        </script>
    </body>
